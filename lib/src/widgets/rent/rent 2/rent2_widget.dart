...
class SecondRentWidget extends StatefulWidget {
  final String image;
  final String house;
  ...
  const SecondRentWidget({Key? key, required this.image, required this.house, required this.housename, required this.rating, required this.location, required this.price, required this.onTap}) : super(key: key);

  @override
  State<SecondRentWidget> createState() => _SecondRentWidgetState();
}

class _SecondRentWidgetState extends State<SecondRentWidget> {
  @override
  bool _pop = false;
      ...
      child: Row(children: [
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
            ...
            Row(children: [
              SizedBox(width: 16,),
              Text("\$",style: Appstyle.sixteen(Color(0xFF252B5C)),),
              SizedBox(width: 5,),
              Text(widget.price,style: Appstyle.sixteen(Color(0xFF252B5C)),),
              Text("/month",style: Appstyle.twelve(Color(0xFF252B5C)),),
            ],)
          ],),
        )
      ],),
